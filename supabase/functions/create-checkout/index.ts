...
serve(async (req) => {
  ...
  try {
    ...
    const planPricing = {
      basic: { amount: 2900, name: "Basic Plan - Akses Kelas Dasar" },
      premium: { amount: 4900, name: "Premium Plan - Akses Semua Kelas" },
      enterprise: { amount: 9900, name: "Enterprise Plan - Akses Premium + Video" }
    };
